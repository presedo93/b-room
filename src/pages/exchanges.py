        ...
        with tab1:
            with st.expander("Instruments"):
                ...
                if c2.button("Populate", type="primary", use_container_width=True):
                    ...
                    st.success(
                        f"Fetched {count} ByBit instruments."
                    ) if count else st.warning("No ByBit instruments found.")
